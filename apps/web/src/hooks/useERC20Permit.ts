...
import { AGX, DAI, USDC_MAINNET } from 'uniswap/src/constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [UniverseChainId.Mainnet]: {
    ...
    [AGX[UniverseChainId.Mainnet].address]: { type: PermitType.AMOUNT, name: 'Agroswap' },
  },
  [UniverseChainId.Sepolia]: {
    [AGX[UniverseChainId.Sepolia].address]: { type: PermitType.AMOUNT, name: 'Agroswap' },
  },
}
