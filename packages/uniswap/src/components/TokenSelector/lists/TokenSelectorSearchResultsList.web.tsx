// Web-specific version - Vite will resolve this when importing TokenSelectorSearchResultsList on web
...
import { useTokenSectionsForSearchResults } from 'uniswap/src/components/TokenSelector/hooks/useTokenSectionsForSearchResults.web'
